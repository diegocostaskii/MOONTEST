...
urlList.append('https://dumps.wikimedia.org/zhwiki/20250201/zhwiki-20250201-pages-articles-multistream2.xml-p187713p630160.bz2')
urlList.append('https://dumps.wikimedia.org/zhwiki/20250201/zhwiki-20250201-pages-articles-multistream3.xml-p630161p1389648.bz2')
urlList.append('https://dumps.wikimedia.org/zhwiki/20250201/zhwiki-20250201-pages-articles-multistream4.xml-p1389649p2889648.bz2')
urlList.append('https://dumps.wikimedia.org/zhwiki/20250201/zhwiki-20250201-pages-articles-multistream5.xml-p3391030p4891029.bz2')
urlList.append('https://dumps.wikimedia.org/zhwiki/20250201/zhwiki-20250201-pages-articles-multistream5.xml-p4891030p5596379.bz2')
...
for i in range(len(pathList)):
    ...
    if curCount < maxCount:
        if not os.path.exists(pathList[i]):
            ...
            curCount = parse(pathList[i],'result.jsonl', curCount)
        else:
            curCount = parse(pathList[i],'result.jsonl', curCount)
